...
export default function ErrorAlarmMonitor() {
  ...
  return (
    <>
      <div className="error-alarm-monitor" style={{maxWidth:600,margin:"32px auto"}}>
        <h2 style={{color:"#F44336"}}>Fehler- & Alarmmonitor</h2>
        {alarms.length === 0 && <div style={{color:"#999"}}>Keine aktuellen Fehler oder Warnungen.</div>}
