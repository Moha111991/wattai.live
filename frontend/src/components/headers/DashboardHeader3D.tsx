export default function DashboardHeader3D() {
  return (
    <svg viewBox="0 0 1200 400" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', display: 'block' }}>
      ...
      <text x="60" y="340" fontSize="52" fontWeight="bold" fill="url(#animGrad)" textAnchor="start" filter="url(#dashGlow)">
        Dashboard
      </text>
      <text x="62" y="376" fontSize="17" fill="#67e8f9" textAnchor="start" opacity="0.75" letterSpacing="2">
