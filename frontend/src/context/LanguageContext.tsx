...
const AUTO_TRANSLATION_OVERRIDES: Record<string, string> = {
  ...
  // ── Dashboard EV Control (DashboardSimple) ────────────────────────────────
  'E-Auto SOC': 'EV State of Charge',
  'E-Auto Leistung': 'EV Power',
  'E-Auto Steuerung': 'EV Control',
  'E\u2011Auto Steuerung': 'EV Control',
  'E-Auto laden': 'Charge EV',
  'E-Auto Hersteller': 'EV Manufacturer',
  'E-Auto Profil': 'EV Profile',
  'E-Auto wird nicht mehr das Haus versorgen.': 'The EV will no longer power the house.',
  'E-Auto wird das Haus mit Strom versorgen.': 'The EV will supply the house with power.',
  'V2H (Vehicle-to-Home): E-Auto versorgt Haus bei Spitzenlast (z.B. Winter: niedriger PV-Ertrag + hoher Wärmepumpenbedarf)': 'V2H (Vehicle-to-Home): EV powers home during peak load (e.g. winter: low PV yield + high heat pump demand)',
  'Haus versorgen (V2H)': 'Power home (V2H)',
  'Keine Aktion': 'No action',
  'Lädt...': 'Charging...',
  'Versorgt Haus': 'Powering home',
  'Entladen (V2H)': 'Discharging (V2H)',
  'Keine Aktivität': 'No activity',
  'Laden starten': 'Start charging',
  'Laden stoppen': 'Stop charging',
  'V2H stoppen': 'Stop V2H',
  'V2H aktivieren': 'Activate V2H',
  'V2H deaktivieren': 'Deactivate V2H',
  'deaktivieren': 'deactivate',
  'Hausspeicher': 'Home Battery',
  'PV-Leistung': 'PV Power',
  'Netz Import': 'Grid Import',
  'Netz Export': 'Grid Export',
  'PV-Anlage verbinden': 'Connect PV system',
  'Kein Wechselrichter ausgewählt': 'No inverter selected',
  'Fehler beim Laden der Inverter-Daten': 'Error loading inverter data',
  'Verbraucher:': 'Consumer:',
  'Verbrauch (Smart Meter)': 'Consumption (Smart Meter)',
  'KI-Energiemanagement': 'AI Energy Management',
  'Optimierung läuft...': 'Optimizing...',
  'Energiefluss optimieren': 'Optimize energy flow',
  'Empfehlung:': 'Recommendation:',
  'EV-Ladeleistung:': 'EV charging power:',
  'Batterie laden:': 'Charge battery:',
  'Batterie entladen:': 'Discharge battery:',
  'Netzimport:': 'Grid import:',
  'Netzexport:': 'Grid export:',
  'KI-Confidence:': 'AI Confidence:',
  'Fahrzeug-Zuweisung': 'Vehicle Assignment',
  'EV-Profile': 'EV Profiles',
  'Aktivieren': 'Activate',
  'PV-Ertrag (24h)': 'PV Yield (24h)',
  'Verbrauch (24h)': 'Consumption (24h)',
  'Verbrauch': 'Consumption',
  'Inaktiv': 'Inactive',
  'Mindest-SOC für V2H:': 'Minimum SOC for V2H:',
  '(Schutz vor Tiefentladung)': '(Protection against deep discharge)',
  'Verbunden:': 'Connected:',
  ...
  'Verbinde mit Smart Meter…': 'Connecting to Smart Meter…',
  'Kein Smart Meter verbunden': 'No Smart Meter connected',
  'Sobald Ihr Wechselrichter oder Smart Meter verbunden ist, erscheinen hier alle Echtzeit-Energiedaten automatisch.': 'Once your inverter or smart meter is connected, all real-time energy data will appear here automatically.',
  'Erste Schritte': 'Getting started',
  'Wechselrichter oder Smart Meter einschalten': 'Turn on inverter or smart meter',
  'Gerät im selben Netzwerk wie dieses System betreiben': 'Connect device to the same network as this system',
  'Verbindung über Geräte-Tab herstellen': 'Establish connection via Devices tab',
  'Diese Karte aktualisiert sich automatisch nach der Verbindung': 'This card updates automatically after connection',

  // ── EVProfileManager ───────────────────────────────────────────────────────
  'Aktives Fahrzeug': 'Active Vehicle',
  'Datenquelle:': 'Data source:',
  'Zuweisung aufheben': 'Remove assignment',
  'Kein Fahrzeug zugewiesen': 'No vehicle assigned',
  'Batterie-Analyse': 'Battery Analysis',
  'Ladeleistung:': 'Charging power:',
  'Kapazität:': 'Capacity:',
  'Rest bis 100%:': 'Remaining to 100%:',
  'Neues EV-Profil': 'New EV Profile',
  'Hersteller wählen': 'Select manufacturer',
  'Modell wählen': 'Select model',
